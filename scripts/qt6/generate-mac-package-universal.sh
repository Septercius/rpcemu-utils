...
function configureForArm
{
	...
	PATH=$PATH:$QTDIR/bin qmake $CONFIGVALUE "QMAKE_APPLE_DEVICE_ARCHS=arm64" -after DESTDIR=../apps ../../../../src/qt6/rpcemu.pro
}
...
function configureForX86
{
	...
	PATH=$PATH:$QTDIR/bin qmake $CONFIGVALUE "QMAKE_APPLE_DEVICE_ARCHS=x86_64" -after DESTDIR=../apps ../../../../src/qt6/rpcemu.pro
}
